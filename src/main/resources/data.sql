...
SELECT * FROM (VALUES
    ('Vesak Festival',
     ...
     'FESTIVAL', 'Island-wide', '2026-05-12'::date, '2026-05-13'::date, true, NOW()),
    ('Esala Perahera',
     'Grand procession of the Temple of the Tooth Relic in Kandy. Elephants, drummers, fire dancers in spectacular parade.',
     'FESTIVAL', 'Kandy', '2026-08-03'::date, '2026-08-13'::date,true, NOW()),
    ...
    ('Kataragama Festival',
     ...
     'RELIGIOUS', 'Kataragama', '2026-07-28'::date, '2026-08-06'::date, true, NOW()),
    ('Elephant Gathering — Minneriya',
     ...
     'WILDLIFE', 'Minneriya', '2026-07-01'::date, '2026-09-30'::date, true, NOW()),
    ('Whale Watching Season — Mirissa',
     ...
     'WILDLIFE', 'Mirissa', '2026-11-01'::date, '2027-04-30'::date, true, NOW()),
    ...
    ('Christmas in Galle Fort',
     ...
     'FESTIVAL', 'Galle', '2026-12-24'::date, '2026-12-26'::date,true, NOW()),
    ('Hikkaduwa Coral Festival',
     ...
     'ENTERTAINMENT', 'Hikkaduwa', '2026-03-01'::date, '2026-03-03'::date, true, NOW())
