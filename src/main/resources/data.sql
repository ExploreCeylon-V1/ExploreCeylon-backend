...
('Sigiriya',
 ...
 'Sigiriya or Lion Rock is an ancient rock fortress and palace ruin situated in the central Matale District. A UNESCO World Heritage Site rising 200 metres above the surrounding plains. The site contains the ruins of an ancient palace complex built by King Kashyapa I.',
 ...
 'USD 30 (foreigners), LKR 100 (locals)',
 '7:00 AM - 5:30 PM daily',
 true, true, 4.8, 1250,
 'UNESCO World Heritage Site', NOW(), NOW()),

('Ella',
 'Badulla', 'Uva Province',
 'Ella is a small town in the Badulla District surrounded by mountains and tea plantations. Famous for the Nine Arch Bridge, Ella Rock hike, and the scenic train journey from Kandy. A backpacker favourite with a relaxed atmosphere.',
...
('Kandy',
 ...
 'Kandy is the cultural capital of Sri Lanka and home to the famous Temple of the Tooth Relic. Situated amidst hills and the Kandy Lake, it is a UNESCO World Heritage Site. The annual Esala Perahera festival in August is one of the grandest processions in Asia.',
 ...
 'Temple: USD 15 (foreigners)',
 'Open all day — Temple 5:30AM-8PM',
 true, true, 4.6, 1456,
 'UNESCO World Heritage Site', NOW(), NOW()),

('Yala National Park',
 'Hambantota', 'Southern Province',
 'Yala National Park is the most visited and second largest national park in Sri Lanka. It has the highest density of leopards in the world. The park also shelters elephants, sloth bears, water buffaloes, crocodiles and hundreds of bird species.',
 ...
 'USD 25 per person + USD 15 vehicle (foreigners)',
 '6:00 AM - 6:00 PM (Block 1)',
 true, true, 4.9, 2341,
 NULL, NOW(), NOW()),

('Galle Fort',
 'Galle', 'Southern Province',
 'Galle Fort is a UNESCO World Heritage Site built first in 1588 by the Portuguese and then extensively fortified by the Dutch during the 17th century. The fort contains streets lined with Dutch colonial buildings now housing boutique hotels, cafes, galleries and shops.',
...
('Mirissa',
 ...
 'Mirissa is a small town on the south coast of Sri Lanka known for its beautiful crescent-shaped beach and world-class whale watching. Blue whales and sperm whales can be spotted from November to April. The beach has a relaxed backpacker vibe.',
 ...
 'Beach free. Whale watching USD 30-40',
 'Open all day',
 true, true, 4.6, 1123,
 NULL, NOW(), NOW()),
...
('Arugam Bay',
 ...
 'Arugam Bay is a small bay on the Indian Ocean in Sri Lanka''s dry zone. It is internationally renowned as one of the top surfing destinations in the world. The Main Point surf break is famous among professional surfers. Best from May to October.',
 ...
 'Beach free. Surf lessons USD 20-30',
 'Open all day',
 true, true, 4.7, 876,
 NULL, NOW(), NOW()),
...
('Nuwara Eliya',
 ...
 'Nuwara Eliya is a city in the tea country of central Sri Lanka. It is nicknamed Little England due to its British colonial architecture. Surrounded by tea estates, waterfalls and the Horton Plains National Park with the dramatic World''s End cliff.',
 ...
 'Horton Plains: USD 25 (foreigners)',
 'Open all day — Horton Plains 6AM-6PM',
 true, true, 4.5, 765,
 NULL, NOW(), NOW()),

('Trincomalee',
 'Trincomalee', 'Eastern Province',
 'Trincomalee is a port city on the northeast coast known for one of the finest natural harbours in the world. Nilaveli and Uppuveli beaches offer crystal clear water and excellent snorkeling at Pigeon Island. Best visited April to September.',
 ...
 'Pigeon Island: USD 15 (foreigners)',
 'Open all day',
 false, true, 4.6, 543,
 NULL, NOW(), NOW()),
...
('Anuradhapura',
 ...
 'Anuradhapura is one of the ancient capitals of Sri Lanka and is a UNESCO World Heritage Site. The sacred city contains the Sri Maha Bodhi tree — the oldest human-planted tree in the world — along with massive dagobas and ancient ruins of palaces.',
...
('Polonnaruwa',
 ...
 'Polonnaruwa is the second most ancient of Sri Lanka''s kingdoms. A UNESCO World Heritage Site with well-preserved ruins including the Gal Vihara rock temple with its magnificent Buddha statues carved from a single granite face.',
...
('Jaffna',
 ...
 'Jaffna is the largest city in northern Sri Lanka with a distinct Tamil culture. Known for its unique cuisine, colorful Hindu temples and the historic Jaffna Fort. The Nainativu and Nagadeepa islands offer beautiful temples accessible by boat.',
