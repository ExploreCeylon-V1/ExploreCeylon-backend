...
SELECT * FROM (VALUES
    ('Colombo City Tuk-Tuk', 'TUKTUK', 'Bajaj', 'RE', 2022, 3, 'Yellow',
        ...
        NOW(), NOW()),
    ('Colombo City Van', 'VAN', 'Toyota', 'HiAce', 2021, 8, 'White',
        45.00, 'USD', 'Colombo', 'Colombo 03',
        true, true,
        'Nimal Perera', '+94777654321', 'English, Sinhala, Tamil',
        'Comfortable van with AC for city and countryside trips', 4.8, 85, 'STANDARD',
        NOW(), NOW()),
